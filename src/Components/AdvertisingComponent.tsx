...
const AdvertisingComponent = (props: Props) => {
  return (
    <div className="relative h-[40px] flex items-center gap-x-6 overflow-hidden bg-transparent px-6  sm:px-3.5 sm:before:flex-1 z-50">
      <div
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        <p className="text-sm leading-6 ">
          <strong className="font-semibold">Let's say your company name</strong>
